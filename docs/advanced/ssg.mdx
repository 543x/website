...
- Our [live codeblock](../guides/markdown-features/markdown-features-code-blocks.md#interactive-code-editor), which runs in the browser's JS runtime
- Our [themed image](../guides/markdown-features/markdown-features-assets.md#themed-images) that detects the user's color scheme to display different images
