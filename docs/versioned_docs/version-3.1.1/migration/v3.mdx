...
MDX is a major dependency of Docusaurus responsible for compiling your `.md` and `.md` files to React components.
...
Make sure to also read our updated [**MDX and React**](../guides/markdown-features/markdown-features-react.md) documentation page.
...
For users providing a [custom `MDXComponent`mapping](../guides/markdown-features/markdown-features-react.md#mdx-component-scope), components are now "sandboxed":
...
Your [`MDXComponent` component mapping](../guides/markdown-features/markdown-features-react.md#mdx-component-scope) might not be applied as before, and your custom components might no longer be used.
...
We recommend using the `.md` extension whenever you use JSX, `import`, or `export` (i.e. MDX features) inside a Markdown file. It is semantically more correct and improves compatibility with external tools (IDEs, formatters, linters, etc.).
...
If you use Docusaurus to render [Math Equations](../guides/markdown-features/markdown-features-math-equations.md), you should upgrade the MDX plugins.
...
Docusaurus v3 comes with [MDX v1 compatibility options](../api/docusaurus.config.js.md#markdown), that are turned on by default.
...
This option allows the usage of the Docusaurus v2 [admonition title](../guides/markdown-features/markdown-features-admonitions.md#specifying-title) syntax:
...
This option allows the usage of the Docusaurus v2 [explicit heading id](../guides/markdown-features/markdown-features-toc.md#heading-ids) syntax:
