...
For files using the `.md` extension, use a [MDX](https://mdxjs.com/) comment `{/* truncate */}` instead:
...
| MDX file | `2021-05-28-my-blog-post-title.md` |
...
It is possible to define tags inline, or to reference predefined tags declared in a [`tags file`](api/plugins/plugin-content-blog.md#tags-file) (optional, usually `blog/tags.yml`).
