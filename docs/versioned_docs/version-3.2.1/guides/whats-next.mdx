...
- [Used the blog plugin](../blog.md) to create a fully featured blog
- Tried your hands on [a range of Markdown features](./markdown-features/markdown-features-intro.md), which are useful for all content plugins
...
- [Deployed](../deployment.md) your site to a content host
