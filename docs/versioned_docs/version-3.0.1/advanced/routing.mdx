...
- If the path has any other extension, Docusaurus would treat it as [an asset](../guides/markdown-features/markdown-features-assets.md) and bundle it.
...
│   ├── 2021-08-01-mdx-blog-post.md        # -> /blog/2021/08/01/mdx-blog-post
│   └── 2021-08-26-welcome
...
│   │   └── markdown-features.md           # -> /docs/tutorial-basics/markdown-features
│   └── tutorial-extras
│       ├── _category_.json
...
└── versioned_docs
    └── version-1.0.0               # version has base path '/1.0.0'
        ...
        │   └── markdown-features.md       # -> /docs/1.0.0/tutorial-basics/markdown-features
        └── tutorial-extras
            ├── _category_.json
