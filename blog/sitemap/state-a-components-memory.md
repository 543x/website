...
export const sculptureList = [{
  ...
  description: 'The Nanas are triumphant creatures, symbols of femininity and maternity. Initially, Saint Phalle used fabric and found objects for the Nanas, and later on duced polyester to achieve a more vibrant effect.',
...
A state variable is only necessary to keep information between re-renders of a component. Within a single event handler, a regular variable will do fine. Don't duce state variables when a regular variable works well.
